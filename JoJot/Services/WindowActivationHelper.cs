...
namespace JoJot.Services
{
    ...
    /// Uses AttachThreadInput + SetForegroundWindow to reliably bring the window to the foreground
    /// even when a different application currently has focus.
    /// </summary>
    public static class WindowActivationHelper
    {
        ...
        public static void ActivateWindow(Window window)
        {
            ...
            // Attach to foreground window's thread so SetForegroundWindow succeeds
